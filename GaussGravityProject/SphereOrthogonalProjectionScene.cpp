...
const std::list<SphereOrthogonalProjectionScene::PointContainer>&
SphereOrthogonalProjectionScene::getPointContainerList() const {
...
void SphereOrthogonalProjectionScene::removeMaterialPoint(std::list<PointContainer>::iterator containerIterator) {
    removeItem(containerIterator->ellipseItem);
    delete containerIterator->ellipseItem;
    pointContainerList.erase(containerIterator);
}
...
const SphereGravityModel::Iterator &SphereOrthogonalProjectionScene::PointContainer::getPointIterator() const {
    return pointIterator;
}

QGraphicsEllipseItem *SphereOrthogonalProjectionScene::PointContainer::getEllipseItem() const {
    return ellipseItem;
}
